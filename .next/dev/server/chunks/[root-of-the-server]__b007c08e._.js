...
if (("TURBOPACK compile-time value", "development") === 'production' || process.env.DATABASE_URL?.includes('neondb')) {
    ...
    if (!/*TURBOPACK member replacement*/ __turbopack_context__.g.pgPool) {
        /*TURBOPACK member replacement*/ __turbopack_context__.g.pgPool = new __TURBOPACK__imported__module__$5b$externals$5d2f$pg__$5b$external$5d$__$28$pg$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$pg$29$__["Pool"](poolConfig);
    }
    pool = /*TURBOPACK member replacement*/ __turbopack_context__.g.pgPool;
}
...
async function PATCH(req, { params }) {
    try {
        ...
        const targetUserRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT email FROM users WHERE id = $1', [
            id
        ]);
        if (targetUserRes.rows.length > 0) {
            ...
            if (targetEmail === 'test@test.com' && role) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Cannot modify Main Admin role'
                }, {
                    status: 403
                });
            }
      ...
      role`;
        values.push(id);
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(query, values);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b007c08e._.js.map