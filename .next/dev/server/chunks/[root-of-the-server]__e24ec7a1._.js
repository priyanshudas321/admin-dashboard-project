...
async function POST(req) {
    try {
        ...
        if (!dbPassword) {
            console.error('Password column not found in user record', {
                id: user.id
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const isValidPassword = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["comparePassword"])(password, dbPassword);
        if (!isValidPassword) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Invalid credentials'
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e24ec7a1._.js.map